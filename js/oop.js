...
function Hamburger(bunType, vegetableGarnish, cheeseType, sauseType, meatPattyType, pattyNumber, picklesNum, hotPeppersNum, olivesNum) {
    this.bunType = bunType;
    this.vegetableGarnish = vegetableGarnish;
    this.cheeseType = cheeseType;
    this.sauseType = sauseType;
    this.meatPattyType = meatPattyType;
    this.pattyNumber = pattyNumber;
    this.picklesNum = picklesNum;
    this.hotPeppersNum = hotPeppersNum;
    this.olivesNum = olivesNum;
    this.bio = function () {
        return `The hamburger consists of ${this.bunType} bun, ${this.vegetableGarnish}, ${this.cheeseType}, ${this.sauseType} sause, ${this.pattyNumber} ${this.meatPattyType} patty, ${this.picklesNum} pickle slice(s), ${this.hotPeppersNum} hot pepper part(s), and ${this.olivesNum} olive(s)`;
    }
}
